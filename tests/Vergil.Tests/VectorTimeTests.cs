#region copyright
// -----------------------------------------------------------------------
//  <copyright file="VectorTimeTests.cs" company="Akka.NET Project">
...
namespace Vergil.Tests
{
    public class VectorTimeTests
    {
        ...
        [Fact]
        public void A_VectorTime_must_support_pruning()
        {
            var node1 = "1";
            var node2 = "2";
            var node3 = "3";
            ...
            c1[node1].Should().Be(0);
            (c1 != c).Should().BeTrue();

            c.Prune(node1).Merge(c1)[node1].Should().Be(0);
        ...
        [Fact]
        public void A_VectorTime_must_compare_as_Concurrent_when_Member_removed()
        {
            var node1 = "1";
            var node2 = "2";

            var a = VectorTime.Zero.Increment(node1).Increment(node2);
